    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                ...
                console.log("ghost connected successfully☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Ghost by Iro And Bera is installing cmds😇\n\n");
                ...
                fs.readdirSync(__dirname + "/commandes").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            ...
                            console.log(fichier + "Successfully installed Ghost commands");
                        }
                        catch (e) {
                ...
                console.log("ghost successfully connected�?");
...
> Ghost MD`;
                ...
                if (raisonDeconnexion === baileys_1.DisconnectReason.badSession) {
                    ...
                    console.log('connection error😞 ,, ghost trying to reconnect... ');
                    main();
                }
